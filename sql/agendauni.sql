...
SET DEFINE OFF;
Insert into AGENDAU.USUARIOS (OID_U,NOMBRE,APELLIDOS,TIPOUSUARIO,UVUS,PASS) values ('1','Julia','Iba�ez Montero','ADMIN','julibamon@us.es','1234');
Insert into AGENDAU.USUARIOS (OID_U,NOMBRE,APELLIDOS,TIPOUSUARIO,UVUS,PASS) values ('2','Flora','Viegas Pe�alosa','ADMIN','floviepen@us.es','1234');
--------------------------------------------------------
